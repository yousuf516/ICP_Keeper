...
import { idlFactory } from './ICP_Keeper_backend.did.js';
export { idlFactory } from './ICP_Keeper_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ICP_KEEPER_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ICP_Keeper_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ICP_Keeper_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ICP_Keeper_backend.did.js")._SERVICE>}
 */
export const ICP_Keeper_backend = createActor(canisterId);
