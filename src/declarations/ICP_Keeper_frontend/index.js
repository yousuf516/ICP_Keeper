...
import { idlFactory } from './ICP_Keeper_frontend.did.js';
export { idlFactory } from './ICP_Keeper_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ICP_KEEPER_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ICP_Keeper_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ICP_Keeper_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ICP_Keeper_frontend.did.js")._SERVICE>}
 */
export const ICP_Keeper_frontend = createActor(canisterId);
